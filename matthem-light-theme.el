;;; matthem-light-theme.el --- theme                             -*- lexical-binding: t; -*-
...
;; `modus-operandi-tinted' with small changes to match my expectations

;;; Code:

(defvar mattheme-light-custom-faces
  '(
...
(modus-themes-theme
 'matthem-light
 'matthem-themes
 "The `matthem-light' theme."
 'light
 'modus-operandi-tinted-palette
 nil
 nil
 'mattheme-light-custom-faces)
...
(provide 'matthem-light)
;;; matthem-light-theme.el ends here
