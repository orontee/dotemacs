...
| url-shortener           | shorten long url and expand tinyurl                                |
| telephone-line          | Rewrite of Powerline                                               |
...
| git-doc                 | Info documentation for git                                         |
...
| color-theme-github      | Github color theme for GNU Emacs.                                  |
| color-theme-cobalt      | Cobalt Color Theme for Emacs                                       |
| color-theme-actress     | A dark color theme for GNU Emacs.                                  |
...
(setq whitespace-style
      (quote (face spaces tabs newline space-mark trailing
