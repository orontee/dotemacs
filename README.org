...
#+begin_src emacs-lisp :tangle init.el
  ...
  (defalias 'bookmark-switch-bookmarks-candidate 'bookmark-project-bookmarks)
  ...
  (defun bookmark-switch-bookmarks (file)
    ...
    FILE. Subsequent call to `bookmark-bmenu-save' update FILE. Note that
    `bookmark-default-file' is kept unchanged."
    (interactive (list
