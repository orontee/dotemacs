...
#+begin_src emacs-lisp :tangle .emacs
;; Francisation du calendrier et du journal.
...
(setq view-diary-entries-initially t
      ...
      other-holidays '((holiday-fixed 5 8 "Victory")
		       ...
		       (holiday-fixed 5 1 "Work Day")
		       (holiday-float 11 1 1 "Soul's Day")))
...
#+begin_src emacs-lisp :tangle .emacs-lisp
...
#+begin_src emacs-lisp :tangle .emacs
;; Définit des raccourcis clavier permettant de sélectionner les
;; méthodes de saisie qui me sont utiles.
...
#+begin_src emacs-lisp :tangle .emacs
;; Le mode `foldout' étend le mode `outline' en offrant la possibilité
;; de zoomer sur des portions de tampon. Il ajoute d'indispensables
;; combinaisons de touche et boutons de souris.
